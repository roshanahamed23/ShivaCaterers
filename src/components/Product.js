...
const productInfo = [
  ...
  },
  {
    ...
    description:
      "Culinary delights to enhance networking events, fostering connections and collaborations.",
    buttonText: "View Details",
  ...
  },
  {
    ...
    title: "Wedding Event",
    description:
      " Elegant menus and flawless service for your unforgettable wedding celebration.",
    buttonText: "View Details",
  ...
  return (
    <div id="service" className="bg-black text-white p-4 text-center">
      <h2 className="font-merriweather text-xl font-bold">
        Catering <span className="text-red">Service</span>
      </h2>
