...
const ServiceForm = () => {
  ...
  const handleSubmit = (e) => {
    axios
      .post("/api/customer", { name, email, service })
      .then((res) => console.log(res));
    axios
      .post("/api/mail", { name, email, phone, service, details })
      .then((res) => console.log(res));
  };
  ...
  return (
    <div className="p-4 h-auto flex items-center justify-center  rounded-2xl">
      <form
        ...
        className=" bg-rose-800 flex flex-col gap-4 p-6 rounded-lg shadow-lg w-full"
      >
        <div className="mb-4">
